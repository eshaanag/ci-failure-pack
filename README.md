...
| ✅ Complete    | CLI `diff`                                                                              |
| 🔄 In Progress | CLI `capture-local`                                                                     |
| 📋 Planned     | CLI `replay`, `history`, and `open`                                                     |
...
Current implementation status: `inspect` and `diff` are implemented; `capture-local` and `replay` continue in Phase 3.
