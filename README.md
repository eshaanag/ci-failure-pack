...
| 🔄 In Progress | CLI `inspect`                                                                           |
| 📋 Planned     | CLI `diff`, `capture-local`, `replay`, `history`, and `open`                            |
...
Current implementation status: the CLI shell exists; full command behavior lands in Phase 3.
